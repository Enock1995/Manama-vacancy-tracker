...
class UpdateVacantPostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cadre_id'                       => 'sometimes|exists:cadres,id',
            'grade_scale'                    => 'nullable|string|max:10',
            'department'                     => 'nullable|string|max:100',
            'post_category'                  => 'sometimes|in:Clinical,Paramedical,Nursing,Environmental Health,Administrative,Support Services',
            'is_essential_service'           => 'boolean',
            'date_fell_vacant'               => 'sometimes|date|before_or_equal:today',
            'reason_for_vacancy'             => 'sometimes|in:Retirement,Resignation,Death,Transfer,Promotion,Dismissal,Study Leave,Secondment,New Post',
            'previous_incumbent_name'        => 'nullable|string|max:150',
            'patient_care_impact'            => 'sometimes|in:Critical,Significant,Moderate,Minimal',
            'is_post_covered'                => 'sometimes|in:Yes,No,Partially',
            ...
            'overall_status'                 => 'sometimes|in:Vacant - No TC,TC Pending - MOHCC,TC Pending - MOF,TC Granted,TC Expired,Recruiting,Appointment Stage,Filled,Filled - Unconfirmed,Frozen,Abolished',
            'priority_level'                 => 'sometimes|in:1-Critical,2-High,3-Medium,4-Low',
